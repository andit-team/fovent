...
class UserSubAgentConrtoller extends PanelController
{
    ...
    public function setup()
	{
		...
		*/
		...
		$this->xPanel->addClause('where', 'ref_type', 'sub-agent');
		...
		$this->xPanel->setRoute(admin_uri('user-sub-agent'));
		$this->xPanel->setEntityNameStrings(trans('user-sub-agent'), trans('user-sub-agent'));
