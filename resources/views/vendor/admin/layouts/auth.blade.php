...
<div class="main-wrapper">
    ...
    <div class="auth-wrapper d-flex no-block justify-content-center align-items-center"
         style="background:url({{ imgUrl(config('settings.app.login_bg_image'), 'bgBody') }}) no-repeat center center; background-size: cover;"
    >
        <div class="auth-box p-4 bg-white rounded">
    
            <div class="logo text-center mb-5">
                <a href="{{ url('/') }}">
                    <img src="{{ imgUrl(config('settings.app.logo_dark'), 'adminLogo') }}" alt="logo" class="img-fluid" style="width:250px; height:auto;">
                </a>
                <hr>
            </div>
