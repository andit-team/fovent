	...
	<div class="row page-titles">
		<div class="col-md-6 col-12 align-self-center">
			<h3 class="mb-0">
				...
				<small>{{ trans('admin.all') }} <span>{!! $xPanel->entityNamePlural !!}</span> {{ trans('admin.in_the_database') }}.</small>
			</h3>
		</div>
		...
		<div class="col-12">
			...
			<div class="card mb-0 rounded">
				<div class="card-body">
					...
					<p class="card-text">{!! trans('admin.help_translation_list_entries') !!}</p>
				</div>
			</div>
			@endif
