    ...
    <script>
        @if (isset($packages) and isset($paymentMethods) and $packages->count() > 0 and $paymentMethods->count() > 0)
			...
			$(document).ready(function ()
			{
				...
				console.log("selectedPackage="+selectedPackage+"packagePrice="+packagePrice+"paymentMethod="+paymentMethod+"currentPackagePrice="+currentPackagePrice+"currentPaymentActive="+currentPaymentActive);
